            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <hr>
                  @endif
                  @if(!empty($employee->alt_contact))
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Alt Phone</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                      {{$employee->alt_contact}}
                    </div>
                  </div>
                  <hr>
                  @endif
              ...
              <div class="row gutters-sm">
                <div class="col-mb-8">
                  <div class="card mb-3">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3">Additional Details</h6>
